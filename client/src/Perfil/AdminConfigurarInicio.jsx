...
const [loading, setLoading] = useState(false)
  ...
  useEffect(() => {
    if (categoriaSeleccionada?.nombre)
      fetch(
        "https://free-q3yd.vercel.app/products/filter/" + categoriaSeleccionada.nombre,
        optionGet
      )
        .then(async(r) =>{
          if(r.status===200){
  ...
  const guardardestacado=()=>{
    ...
    fetch("https://free-q3yd.vercel.app/home/destacados", {
      method: "PUT",
  ...
  const guardarelegido=()=>{
    ...
    fetch("https://free-q3yd.vercel.app/home/elegidos", {
      method: "PUT",
  ...
  const guardarSlice=()=>{
    ...
    fetch("https://free-q3yd.vercel.app/home/slice", {
      method: "PUT",
  ...
  const guardarPosters=()=>{
    ...
    fetch("https://free-q3yd.vercel.app/home/posters", {
      method: "PUT",
