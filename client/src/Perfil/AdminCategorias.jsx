...
export default function AdminCategorias(){
    ...
    const optionGet = {
      ...
      useEffect(() => {
        fetch("https://free-q3yd.vercel.app/categories", optionGet).then(r => r.json()).then(e=> setCategorias(e))
      }, [])

      const onSumit =()=>{
        let nCategoria= newCategory
        console.log(nCategoria)
        fetch("https://free-q3yd.vercel.app/categories/add", {
        method: "POST",
      ...
      }).then(r => r.status === 200 ? fetch("https://free-q3yd.vercel.app/categories", optionGet).then(r => r.json()).then(e=> {setCategorias(e); setShowC("lista")
      setNewCategory({
        nombre: ""
      })
      swal("Listo",
    ...
    const onPut = () =>{
        ...
        fetch("https://free-q3yd.vercel.app/category/update",{
            method: "PUT",
    ...
    const handleDelete = (_id) => {
        fetch("https://free-q3yd.vercel.app/category/delete/"+ _id, optionDelete).then(r => r.status === 200 ? fetch("https://free-q3yd.vercel.app/categories", optionGet).then(r => r.json()).then(e=> {setCategorias(e); setShowC("lista")
        swal("Listo",
